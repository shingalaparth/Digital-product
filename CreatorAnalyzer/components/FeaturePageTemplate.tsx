...
export function FeaturePageTemplate({ data }: { data: FeaturePageData }) {
 ...
 <Link
 href="/"
 className="inline-flex items-center gap-2 rounded-xl border border-primary/30 px-6 py-3 text-sm font-semibold text-headline transition hover:bg-primary/10 sm:text-base"
 >
 Watch Demo
 </Link>
 </div>
