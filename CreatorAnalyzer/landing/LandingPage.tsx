...
export function LandingPage() {
  ...
  return (
    <div className="relative overflow-x-hidden bg-bg text-body">
        ...
        <div className="section-shell relative z-10 grid gap-10 text-center md:grid-cols-4">
          {landingContent.stats.map((item) => (
            <div key={item.label} className="group transition-transform duration-300 hover:scale-[1.02]">
              <p className="text-5xl font-black italic tracking-tighter text-hot sm:text-4xl lg:text-5xl">
                {item.value}
              </p>
          ...
          <div className="mt-10 max-w-3xl mx-auto space-y-4 sm:mt-16">
            {landingContent.painSteps.map((step, idx) => (
              <div key={idx} className="flex gap-4 p-4 rounded-xl border border-white/5 bg-white/[0.02] items-start">
                <span className="flex-shrink-0 flex h-6 w-12 items-center justify-center rounded-full bg-hot/10 text-[11px] font-bold text-hot uppercase tracking-wider">
                  Step {idx + 1}
                </span>
            ...
            return (
              <article
                ...
                className={classNames(
                  ...
                  feature.href ? "hover:border-primary/40 hover:shadow-glow" : "",
      ...
      <section data-testid="section-use-cases" className="relative overflow-hidden border-y border-border py-16 sm:py-24 lg:py-32">
        <div className="bg-hero-gradient absolute inset-0 opacity-[0.05]" />
        ...
        <div className="section-shell relative z-10">
          ...
          <div className="mt-8 sm:mt-12">
            ...
            {/* Content Area */}
            <div className="rounded-2xl border border-border bg-card p-6 shadow-xl sm:rounded-t-none sm:p-10 min-h-[400px]">
                ...
                >
                  ...
                  <div className="hidden lg:block">
                    <motion.div
                      ...
                      className="relative aspect-square overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-surface to-card shadow-inner"
                    >
                      <div
                        className="absolute inset-4 bg-cover bg-center rounded-xl opacity-80 border border-border/50 shadow-2xl"
      ...
      <section data-testid="section-case-studies" className="relative overflow-hidden py-16 sm:py-24 lg:py-32">
        <div className="bg-hero-gradient absolute inset-0 opacity-[0.06]" />
        ...
        <div className="section-shell relative z-10">
          ...
          <div className="mt-10 grid gap-4 sm:mt-14 sm:gap-6 md:grid-cols-3">
            {landingContent.caseStudies.items.map((study) => (
              <article
                key={study.title}
                className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-glow sm:p-6"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                <div className="relative z-10">
                  ...
                  <div className="mt-4 flex items-baseline gap-2">
                    <span className="text-3xl font-black text-hot sm:text-4xl">{study.metric}</span>
      ...
      <section data-testid="section-free-tools" className="relative overflow-hidden py-16 sm:py-24 lg:py-32">
        <div className="bg-hero-gradient absolute inset-0 opacity-[0.04]" />

        <div className="section-shell relative z-10">
          <div className="text-center">
            <span className="inline-flex rounded-full bg-hot/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-hot">
              Free Resources
            </span>
            <h2 className="mt-4 text-2xl font-bold text-headline sm:text-3xl lg:text-4xl">
          ...
          <div className="mt-10 grid gap-4 sm:mt-14 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
            {landingContent.freeTools.items.map((tool) => (
              <article
                key={tool.title}
                className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all duration-300 hover:-translate-y-1 hover:border-hot/50 hover:shadow-[0_30px_60px_-20px_rgba(0,0,0,0.6)] sm:p-6"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-hot/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                <div className="relative z-10">
                  <h3 className="text-base font-bold text-headline transition-colors group-hover:text-hot sm:text-lg">{tool.title}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-muted">{tool.description}</p>
                  <div className="mt-4">
                    <span className="inline-flex items-center gap-1.5 text-sm font-bold text-hot transition-colors group-hover:text-primary">
              ...
              return (
                <article
                  ...
                  className={classNames(
                    ...
                    tier.featured ? "border-primary shadow-glow ring-1 ring-primary/20" : "border-border",
                  )}
                >
                  {tier.featured ? (
