    ...
    return (
        <div className="relative overflow-x-hidden text-body">
            ...
            >
                ...
                <div className="section-shell relative z-10">
                    <div className="rounded-3xl border border-primary/30 bg-card p-5 sm:p-10">
                        <h2
                            tabIndex={-1}
                        ...
                        <div className="mt-8 flex justify-center">
                            <button
                                ...
                                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-3 text-base font-semibold text-headline transition hover:bg-primary-dark sm:w-auto"
                            >
                        ...
                        <div className="mt-8 rounded-2xl border border-border bg-surface p-4 sm:p-6">
                            ...
                            {tallyUrl ? (
                                ...
                                >
                                    ...
                                    <button
                                        type="submit"
                                        className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-headline sm:w-auto"
                                    >
