        ...
        <div className="relative overflow-x-hidden  text-body">
                ...
                <div className="section-shell relative z-10 mt-8 text-center sm:mt-12">
                    ...
                    <div className="mt-8 flex items-center justify-center gap-3">
                        ...
                        >
                            <div
                                className={cn(
                                    "absolute top-0.5 h-6 w-6 rounded-full bg-primary transition-transform duration-200",
            ...
            <section className="pb-16 sm:pb-24">
                <div className="section-shell">
                    <div className="mx-auto max-w-6xl grid gap-6 md:grid-cols-3 lg:grid-cols-3">
                        {plans.map((plan) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Link
                                        href={plan.upcoming ? "#" : "https://app.thehooklab.in/login"}
                                        target={plan.upcoming ? undefined : "_blank"}
                                        rel={plan.upcoming ? undefined : "noopener noreferrer"}
                                        className={cn(
                                    ...
                                    >
                                        {plan.upcoming ? "Join Waitlist" : "Start Free Now"} <ArrowRight className="h-4 w-4" />
                                    </Link>
                                </article>
                            );
                        })}
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-border bg-surface/50">
                                    ...
                                    <th className="px-6 py-5 text-center text-xs font-bold uppercase tracking-wider text-primary">Free</th>
                                    <th className="px-6 py-5 text-center text-xs font-bold uppercase tracking-wider text-primary">Pro (Upcoming)</th>
                                    <th className="px-6 py-5 text-center text-xs font-bold uppercase tracking-wider text-primary">Enterprise (Upcoming)</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-border">
                                {/* Core Features */}
                                <tr className="bg-surface/30"><td colSpan={4} className="px-6 py-3 text-xs font-bold uppercase text-muted/60 bg-surface/40">Core Intelligence</td></tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">Deep Reel Analyzer</td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">Content Mix Engine</td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">Facebook Ads Tracking</td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">AI Template Generation</td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
                                ...
                                {/* Premium Features */}
                                <tr className="bg-surface/30"><td colSpan={4} className="px-6 py-3 text-xs font-bold uppercase text-muted/60 bg-surface/40">Premium Features</td></tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">Save & Star Content</td>
                                    <td className="px-6 py-4 text-center"><Minus className="h-4 w-4 text-muted/20 mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">Download Ad Reports</td>
                                    <td className="px-6 py-4 text-center"><Minus className="h-4 w-4 text-muted/20 mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">API Usage</td>
                                    <td className="px-6 py-4 text-center"><Minus className="h-4 w-4 text-muted/20 mx-auto" aria-hidden /></td>
                                ...
                                {/* Support */}
                                <tr className="bg-surface/30"><td colSpan={4} className="px-6 py-3 text-xs font-bold uppercase text-muted/60 bg-surface/40">Support & Team</td></tr>

                                <tr>
                                    <td className="px-6 py-4 text-sm font-medium text-body">Account Manager</td>
                                    <td className="px-6 py-4 text-center"><Minus className="h-4 w-4 text-muted/20 mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Minus className="h-4 w-4 text-muted/20 mx-auto" aria-hidden /></td>
                                    <td className="px-6 py-4 text-center"><Check className="h-4 w-4 text-primary mx-auto" aria-hidden /></td>
                                </tr>
            ...
            <section className="relative overflow-hidden py-16 sm:py-24">
                ...
                <div className="section-shell relative z-10 text-center">
                    <div className="rounded-3xl border border-primary/30 bg-card p-8 sm:p-16">
                        ...
                        <div className="mt-10 flex flex-wrap justify-center gap-4">
                            <Link
                                href="#"
                                className="inline-flex items-center gap-2 rounded-2xl bg-primary px-10 py-4 text-base font-bold text-bg transition-all hover:bg-primary-dark"
                            >
