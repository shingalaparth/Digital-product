...
export const metadata: Metadata = {
 title:"Video Editor Tools | Reel Strategy Service | TheHookLab",
 description:
"Video editors: stop guessing Reel formats. Show clients data-backed recommendations. Upgrade from editor to strategist. Charge 2x. TheHookLab for freelance editors.",
};
...
const data: SolutionPageData = {
 ...
 subtitle:
"Clients hire you for editing, but the ones paying ₹10–15K per Reel are also paying for smart recommendations on what format will win. TheHookLab gives you the data to justify premium pricing.",
...
"You're editing 15–20 Reels per month but missing out on an extra ₹5K per Reel because you can't justify the strategy lift.",
 ...
 description:
"When a client needs a high-conversion Reel, run their niche through TheHookLab to see which format (Tutorial, Social Proof, etc.) drives the most saves and shares. Stop guessing.",
 },
 {
...
"Gain a massive competitive advantage over editors who 'just edit'. Provide format process and advice that makes you indispensable to high-paying agencies.",
 ...
 testimonial: {
 quote:
"I was charging ₹6K per Reel. TheHookLab let me analyze what format works for each niche. I now sell 'Strategic Reel Editing' at ₹12K. 60% of my clients upgrade. Revenue jumped from ₹120K to ₹180K/month.",
