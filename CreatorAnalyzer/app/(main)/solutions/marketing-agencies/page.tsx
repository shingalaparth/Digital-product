...
export const metadata: Metadata = {
 title:"Competitor Analysis for Marketing Agencies | ReelDNA",
 description:
...
const data: SolutionPageData = {
 ...
 subtitle:
"Agencies win clients with strategy, not just execution. ReelDNA gives your team the data to back up recommendations with white-label reports you can sell at a 10x markup.",
...
"Deliver professional competitor briefs with your company's logo and branding. Sell these as standalone strategic projects at ₹25–50K each.",
 ...
 description:
"Stop assigning manual research. ReelDNA monitors your client's niche 24/7. Your strategist spends 2 hours customizing the brief instead of 20 hours gathering data.",
 },
 {
...
"Manage competitive intelligence for 5, 20, or 50+ accounts from a single dashboard. Scale your strategic value without hiring more researchers.",
 ...
 testimonial: {
 quote:
"We were commodity players. Three months after adding ReelDNA, competitor analysis became 30% of our social revenue. We now pitch retainers at ₹75K instead of ₹45K because we have a real differentiator.",
 name:"Agency Director",
 role:"15-Person Team, ₹1.2 Cr Revenue",
 },
 faq: [
 {
 question:"Can we fully white-label and hide ReelDNA's branding? ",
 answer:
...
"Absolutely. The automated brief is your starting point. Your strategist spends 1-2 hours layering on client-specific recommendations and action items.",
 ...
 answer:
"Agencies using ReelDNA during the pre-sales phase report a 2x higher close rate. Showing a potential client their competitor's gaps before you even sign them is a massive win.",
 },
 ],
};
