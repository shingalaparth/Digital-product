...
export const metadata: Metadata = {
 title:"Freelance SMM Tool | Competitor Analysis for Social Managers | ReelDNA",
 description:
"Stop wasting 10 hours/week on competitor research. Get weekly strategy briefs. Charge clients ₹10,000 more per month. ReelDNA for freelance SMMs.",
};
...
const data: SolutionPageData = {
 ...
 subtitle:
"You're already good at managing accounts, but manual research is eating your profits. ReelDNA automates your competitor analysis and turns it into a premium strategy service you can bill for.",
...
"When clients ask 'Why is competitor X doing better than us?', you struggle to provide a data-backed answer that commands respect.",
 ...
 description:
"ReelDNA watches your clients' competitors for you. Receive a professional strategy brief every Friday with hooks, formats, and posting times included.",
 },
 {
...
"Recover 10 hours per week of your life. Reinvest that time into finding new clients, creating better content, or finally taking your weekends back.",
 ...
 testimonial: {
 quote:
"I was spending 8 hours/week on research that clients didn't pay for. Now ReelDNA does it in minutes. I package the briefs into quarterly reports and charge ₹50K each. Three clients signed up. That's ₹150K in new revenue.",
 name:"Freelance SMM",
