...
export const metadata: Metadata = {
 title:"TheHookLab for D2C Brands – Competitor Intelligence for Indian E-Commerce",
 description:
...
const data: SolutionPageData = {
 ...
 subtitle:
"D2C brands like yours lose market share to competitors you don't fully understand. TheHookLab reveals their exact content strategy — hooks, formats, and posting times — so you stop guessing and start winning.",
 hook:"This week alone, 3 D2C brands using TheHookLab uncovered the exact hook their competitors used and tripled their engagement.",
 painPoints: [
...
"Our weekly strategy brief shows you emerging trends in your niche 2–3 weeks before they peak. Post early, dominate the wave, then move to the next.",
 ...
 testimonial: {
 quote:
"We were losing to a competitor we didn't understand. TheHookLab showed us they post at 2 PM Tuesday because that's when their audience is engaged. We changed our schedule and engagement went from 2% to 7%.",
 name:"Founder",
 role:"Skincare D2C Brand",
 },
 faq: [
 {
 question:"Will TheHookLab help if we're in a very niche market? ",
 answer:
