...
export const metadata: Metadata = {
  title: "ReelDNA for D2C Brands – Competitor Intelligence for Indian E-Commerce",
  description:
...
const data: SolutionPageData = {
  ...
  subtitle:
    "D2C brands like yours lose market share to competitors you don't fully understand. ReelDNA reveals their exact content strategy — hooks, formats, and posting times — so you stop guessing and start winning.",
  hook: "This week alone, 3 D2C brands using ReelDNA uncovered the exact hook their competitors used and tripled their engagement.",
  painPoints: [
  ...
  testimonial: {
    quote:
      "We were losing to a competitor we didn't understand. ReelDNA showed us they post at 2 PM Tuesday because that's when their audience is engaged. We changed our schedule and engagement went from 2% to 7%.",
    name: "Founder",
    role: "Skincare D2C Brand",
  },
  faq: [
    {
      question: "Will ReelDNA help if we're in a very niche market?",
      answer:
