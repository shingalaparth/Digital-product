...
export const metadata: Metadata = {
 title:"AI Weekly Strategy Briefs – Content Plans Every Monday | TheHookLab",
 description:
...
const data: FeaturePageData = {
 ...
 description:
"Stop starting your week with 'What should I post?'. TheHookLab delivers a custom, data-backed content plan to your inbox every Monday at 8 AM, so you can focus on creating, not researching.",
 features: [
 {
