...
export const metadata: Metadata = {
  title: "Blog – Social Media Guides & Strategy | ReelDNA",
  description:
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {categories.map((cat) => (
              <Link
                key={cat.href}
                href={cat.href}
                className="group relative overflow-hidden rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-glow sm:p-8"
              >
        ...
        <div className="section-shell relative z-10">
          <div className="rounded-3xl border border-primary/30 bg-card p-5 text-center shadow-glow sm:p-10">
            ...
            <p className="mx-auto mt-3 max-w-xl text-base text-body">
              ReelDNA turns competitive intelligence into actionable growth strategy — automatically.
            </p>
