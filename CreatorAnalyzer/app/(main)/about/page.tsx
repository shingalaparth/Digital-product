    ...
    <div className="relative overflow-x-hidden bg-bg text-body">
            ...
            <div className="lg:w-2/3 space-y-6">
              {[
                ...
                <div key={i} className={classNames(
                  ...
                  i === 0 ? "border-primary/40 bg-card shadow-glow" : "border-border bg-card/40"
                )}>
      ...
      <section className="relative overflow-hidden py-16 sm:py-24">
        ...
        <div className="section-shell relative z-10 text-center">
          <div className="rounded-3xl border border-primary/30 bg-card p-10 shadow-glow sm:p-20">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link
                href="/pricing"
                className="inline-flex items-center gap-2 rounded-2xl bg-primary px-10 py-5 text-lg font-bold text-bg transition hover:bg-primary-dark shadow-glow"
              >
