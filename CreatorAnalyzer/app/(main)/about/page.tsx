...
const values = [
 ...
 description:"We celebrate our customers' wins as our own. When your engagement grows, TheHookLab wins."
 },
];
...
export default function AboutPage() {
 ...
 >
 TheHookLab is independent social media intelligence platform designed to put enterprise-grade AI in the pockets of every Indian entrepreneur.
 </motion.p>
 </div>
 </section>
 ...
 <h2 className="text-3xl font-bold text-headline sm:text-5xl italic tracking-tighter">Why TheHookLab Is Different</h2>
 </div>
