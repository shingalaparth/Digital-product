...
export const metadata: Metadata = {
 title:"Help Center & Documentation | TheHookLab Support",
 description:
"TheHookLab help center with guides for getting started, billing, features, troubleshooting, and API docs. Search for answers or contact support.",
};
...
const categories = [
 ...
 description:"Start here if you're new to TheHookLab. Account setup and first tracking guides.",
 articles: ["What is TheHookLab? ","Sign Up & Create Account","Add Your First Competitor","Dashboard Tour"],
 },
 {
 ...
 description:"Deep dives into how to use TheHookLab's core intelligence features.",
 ...
 description:"For developers integrating TheHookLab into custom agency workflows.",
